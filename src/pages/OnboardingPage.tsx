    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center px-4">
      <div className="max-w-3xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Welcome! Let's Set Up Your Account</h2>
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 mb-6">Tell us about your network infrastructure</p>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-purple-500/20 rounded-lg text-white focus:outline-none focus:border-purple-500/50"
                >
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 mb-6">Choose how you want to send network data to CypherEyes</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className={`p-6 rounded-lg border-2 transition-all ${
                    formData.dataSource === 'api'
                      ...
                      : 'border-purple-500/20 bg-gray-900/50 hover:border-purple-500/40'
                  }`}
                >
                  <Cloud className="w-12 h-12 text-purple-400 mb-3" />
                  <h4 className="text-white font-semibold mb-2">API Integration</h4>
                  <p className="text-sm text-gray-400">Send data via REST API</p>
                </button>
                ...
                >
                  <Server className="w-12 h-12 text-purple-400 mb-3" />
                  <h4 className="text-white font-semibold mb-2">Syslog/PCAP</h4>
                  <p className="text-sm text-gray-400">Forward logs directly</p>
                </button>
              </div>
            </div>
          )}
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 mb-6">Connect your network monitoring tools</p>
              </div>
