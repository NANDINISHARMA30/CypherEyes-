    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition-all"
              >
                SIGN UP
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                We create
                <br />
                <span className="text-orange-500">solutions</span> for
                <br />
                your business
              </h1>
              ...
              <button
                onClick={() => navigate('/signup')}
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all inline-flex items-center"
              >
                Get Started
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 -right-8 w-4 h-4 bg-orange-500 rounded-full opacity-40"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="bg-gradient-to-br from-orange-200 to-orange-300 rounded-2xl p-8 h-80 flex items-center justify-center">
                <div className="text-center">
                  <Lock className="w-20 h-20 text-orange-600 mx-auto mb-4" />
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white font-semibold text-sm mr-4">
                    1
                  </div>
                  <div>
      ...
      <div className="bg-orange-500 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            onClick={() => navigate('/signup')}
            className="bg-white text-orange-500 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition-all"
          >
            CONTACT US
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Web design</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Web development</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">E-Commerce</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Privacy</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Resources</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Become a partner</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Go to Webflow</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Privacy policy</a></li>
                <li><a href="#" className="text-gray-600 hover:text-orange-500">Term & Conditions</a></li>
              </ul>
            </div>
          </div>
